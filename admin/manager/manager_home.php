      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="../manager/attendance.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
$(function(){
  $('#select_year').change(function(){
    window.location.href = 'manager_home.php?year='+$(this).val();
  });
});
</script>
</body>
