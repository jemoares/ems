<?php include '../manager/includes/session.php'; ?>
<?php include '../manager/includes/header.php'; ?>
<body class="hold-transition skin-blue sidebar-mini">
<div class="wrapper">

  <?php include '../manager/includes/navbar.php'; ?>
  <?php include '../manager/includes/menubar.php'; ?>
                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
                          ...
                          <td><img src="<?php echo (!empty($row['photo']))? '../manager/images/'.$row['photo']:'../manager/images/profile.jpg'; ?>" width="30px" height="30px"> <a href="#edit_photo" data-toggle="modal" class="pull-right photo" data-id="<?php echo $row['empid']; ?>"><span class="fa fa-edit"></span></a></td>
  ...
  <?php include '../manager/includes/footer.php'; ?>
  <?php include '../manager/includes/employee_modal.php'; ?>
</div>
<?php include '../manager/includes/scripts.php'; ?>
<script>
$(function(){
